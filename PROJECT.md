...
- Non-technical Windows operators must have a guided entrypoint that installs Tailscale when Windows Package Manager is available, checks Tailscale sign-in, prepares config, installs, verifies, and prints the phone URL.
